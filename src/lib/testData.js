...
const TEST_INGREDIENTS = [
    // Köögiviljad
    { name: 'Kartul', emoji: '🥔', unit: 'g', caloriesPerUnit: 0.77, healthiness: 6, category: 'vegetables' },
    { name: 'Sibul', emoji: '🧅', unit: 'pc', caloriesPerUnit: 40, healthiness: 7, category: 'vegetables' },
    ...
    { name: 'Porgand', emoji: '🥕', unit: 'g', caloriesPerUnit: 0.41, healthiness: 9, category: 'vegetables' },
    { name: 'Tomat', emoji: '🍅', unit: 'g', caloriesPerUnit: 0.18, healthiness: 9, category: 'vegetables' },
    { name: 'Kirsstomat', emoji: '🍅', unit: 'g', caloriesPerUnit: 0.18, healthiness: 9, category: 'vegetables' },
    { name: 'Kurk', emoji: '🥒', unit: 'g', caloriesPerUnit: 0.15, healthiness: 9, category: 'vegetables' },
    { name: 'Marineeritud kurk', emoji: '🥒', unit: 'g', caloriesPerUnit: 0.11, healthiness: 6, category: 'vegetables' },
    { name: 'Paprika', emoji: '🫑', unit: 'pc', caloriesPerUnit: 31, healthiness: 9, category: 'vegetables' },
    { name: 'Küüslauk', emoji: '🧄', unit: 'pc', caloriesPerUnit: 4, healthiness: 9, category: 'vegetables' },
    { name: 'Spinat', emoji: '🥬', unit: 'g', caloriesPerUnit: 0.23, healthiness: 10, category: 'vegetables' },
    { name: 'Brokkoli', emoji: '🥦', unit: 'g', caloriesPerUnit: 0.34, healthiness: 10, category: 'vegetables' },
    { name: 'Lillkapsas', emoji: '🥦', unit: 'g', caloriesPerUnit: 0.25, healthiness: 9, category: 'vegetables' },
    ...
    { name: 'Avokaado', emoji: '🥑', unit: 'pc', caloriesPerUnit: 240, healthiness: 9, category: 'vegetables' },

    // Puuviljad
    { name: 'Õun', emoji: '🍎', unit: 'pc', caloriesPerUnit: 95, healthiness: 9, category: 'fruits' },
    { name: 'Banaan', emoji: '🍌', unit: 'pc', caloriesPerUnit: 105, healthiness: 7, category: 'fruits' },
